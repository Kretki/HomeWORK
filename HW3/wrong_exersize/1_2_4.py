...
img1 = skimage.io.imread('./HW3/wrong_exersize/china_street_cut/image_part_04.jpg')
#img1 = cv2.cvtColor(img1, cv2.COLOR_BGR2RGB)

img2 = skimage.io.imread('./HW3/wrong_exersize/china_street_cut/image_part_05.jpg')
#img2 = cv2.cvtColor(img2, cv2.COLOR_BGR2RGB)

img3 = cv2.imread('./HW3/wrong_exersize/china_street_cut/image_part_06.jpg')
img3 = cv2.cvtColor(img3, cv2.COLOR_BGR2RGB)
match = skimage.exposure.match_histograms(img1, img2, channel_axis=1)#????????????
print(match)
# place = find_piece(img1, img2)
# print(place)
